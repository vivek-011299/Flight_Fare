...
def predict():
    if request.method == 'POST':
        ...
        airline_dict = {'IndiGo': 3, 'Air India': 1, 'Jet Airways': 4, 'SpiceJet': 8, 'Multiple carriers': 6,
                        'GoAir': 2, 'Vistara': 10, 'Air Asia': 0, 'Vistara Premium economy': 11,
                        'Jet Airways Business': 5, 'Multiple carriers Premium economy': 7, 'Trujet': 9}
        ...
        if source == destination:
            ...
            return render_template('index.html', pred=" The Predicted Flight Fare is: INR {}".format(output))
    else:
        return render_template('index.html')
